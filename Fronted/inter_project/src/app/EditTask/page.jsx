...
export default function AddTaskForm() {
  ...
  // Fetch initial task data from URL parameters
  ...
  const [date, setDate] = useState(searchParams.get('Due_Date') ? new Date(searchParams.get('Due_Date')) : null); // Parse date from URL
  ...
  return (
    <div className="className='overflow-hidden bg-custom-image bg-cover bg-center h-screen flex flex-col items-center justify-center">
      <div className="flex flex-col items-center justify-center w-full max-w-2xl mx-auto p-6 bg-white rounded-xl shadow-2xl md:px-12">
        ...
        <button
          ...
          className="w-full px-6 py-2 mt-6 bg-blue-500
text-white rounded-md hover:bg-gradient-to-r from-transparent via-blue-900 focus:outline-none focus:bg-blue-700"
        >
          Update Task
        </button>
        <Toaster />
